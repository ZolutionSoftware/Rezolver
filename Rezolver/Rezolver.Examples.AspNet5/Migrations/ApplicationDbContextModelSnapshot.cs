...
using Rezolver.Examples.AspNet5.Models;

namespace Rezolver.Examples.AspNet5.Migrations
{
    [ContextType(typeof(Rezolver.Examples.AspNet5.Models.ApplicationDbContext))]
    public class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("Rezolver.Examples.AspNet5.Models.ApplicationUser", b =>
                {
                ...
                builder.Entity("Microsoft.AspNet.Identity.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]", b =>
                {
                    b.ForeignKey("Rezolver.Examples.AspNet5.Models.ApplicationUser", "UserId");
                });
