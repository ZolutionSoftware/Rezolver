...
namespace Rezolver.Tests
{
    public class TargetContainerTests
    {
        ...
        /// </summary>
        private class CreateChildTargetContainerIntent
        {
        ...
        private class TypedCreateChildTargetContainerIntent : CreateChildTargetContainerIntent
        {
            public Type Type { get; set; }

            public override bool Validate()
            {
                return base.Validate() && Type != null;
            }
        }
        ...
        /// by the same type.
        /// </summary>
        private class CreateTargetList : TypedCreateChildTargetContainerIntent { }
        ...
        /// </summary>
        private class CreateTargetDictionary : CreateChildTargetContainerIntent { }

        /// <summary>
        /// Indicates an intent to create an ITargetContainer that is bound to a specific open generic type
        /// </summary>
        private class CreateTargetDictionaryForGeneric : CreateChildTargetContainerIntent
        {
            public override bool Validate()
            {
                return base.Validate() && TypeHelpers.IsGenericTypeDefinition(Type);
            }
        }
