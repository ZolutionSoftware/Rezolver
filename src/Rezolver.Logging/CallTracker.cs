...
namespace Rezolver.Logging
{
	...
	public class CallTracker : ICallTracker
	{
		...
		private ObjectFormatterCollection _messageFormatter;
		public ObjectFormatterCollection MessageFormatter
		{
			get { return _messageFormatter; }
			protected set { _messageFormatter = value; }
		}
		...
		/// </summary>
		public bool RetainCompletedCalls { get; protected set; }
		...
		public MessageType? CallEventsMessageType { get; protected set; }
