...
namespace Rezolver
{
    ...
    public static partial class DecoratorTargetContainerExtensions
    {
        ...
        public static void RegisterDecorator<TDecorator, TDecorated>(this IRootTargetContainer targetContainer)
        ...
        /// </remarks>
        public static void RegisterDecorator<TDecorated>(this IRootTargetContainer targetContainer, Func<TDecorated, TDecorated> decoratorDelegate)
        ...
        /// delegate types, primitive objects (e.g. <see cref="int"/>) and so on.
        /// </remarks>
        public static void RegisterDecorator<TDecorated>(this IRootTargetContainer targetContainer, Delegate decoratorDelegate)
            => RegisterDecoratorDelegateInternal(targetContainer ?? throw new ArgumentNullException(nameof(targetContainer)),
                decoratorDelegate ?? throw new ArgumentNullException(nameof(decoratorDelegate)),
                typeof(TDecorated));
        ...
        public static void RegisterDecorator(this IRootTargetContainer targetContainer, Delegate decoratorDelegate, Type decoratedType)
            => RegisterDecoratorDelegateInternal(targetContainer ?? throw new ArgumentNullException(nameof(targetContainer)),
                decoratorDelegate ?? throw new ArgumentNullException(nameof(decoratorDelegate)),
        ...
        public static void RegisterDecorator(this IRootTargetContainer targetContainer, Type decoratorType, Type decoratedType)
            => RegisterDecoratorInternal(targetContainer ?? throw new ArgumentNullException(nameof(targetContainer)),
