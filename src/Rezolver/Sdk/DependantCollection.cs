...
namespace Rezolver.Sdk
{
        ...
        where T : class
    {
        ...
        {
            this._inner = new List<T>(range ?? Enumerable.Empty<T>());
        }
            ...
            where TOriginal : T
        {
            ...
            {
                throw new ArgumentNullException(nameof(replacementCallback));
            }
        ...
        public T this[int index] { get => (T)this._inner[index]; set => this._inner[index] = value; }
        ...
        /// </summary>
        public bool IsReadOnly => ((ICollection<T>)this._inner).IsReadOnly;
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerator<T> GetEnumerator() => this._inner.Cast<T>().GetEnumerator();
