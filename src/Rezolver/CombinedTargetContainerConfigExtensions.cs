...
namespace Rezolver
{
    ...
    public static class CombinedTargetContainerConfigExtensions
    {
        ...
        /// via it's implementation of <see cref="ITargetContainerConfig.Configure(ITargetContainer)"/></param>
        ...
        /// via it's implementation of <see cref="ITargetContainerConfig.Configure(ITargetContainer)"/>.  The callback will be passed the target container being configured at that time.</param>
        /// <returns>The <paramref name="config"/> object, for method chaining.</returns>
        ...
        /// <param name="config">The combined config to which the configuration callback will be added.</param>
        /// <param name="optionValueFactory">A callback which returns value of the option that is to be set when <paramref name="config"/> is applied to an <see cref="ITargetContainer"/>
        /// via it's implementation of <see cref="ITargetContainerConfig.Configure(ITargetContainer)"/>.  The callback will be passed the target container being configured at that time, 
