...
{
	/// <summary>
	/// Interface for an object which configures an <see cref="IContainer"/> and its <see cref="ITargetContainer"/>
    /// before being used.
	/// </summary>
	public interface IContainerConfiguration
	{
		...
		///// <see cref="ICompiledTarget"/> such that when <see cref="ICompiledTarget.GetObject(IResolveContext)"/>
