...
namespace Rezolver.Compilation
{
	...
	{
		private static IContainerBehaviour _defaultProvider = Expressions.ExpressionCompiler.ConfigProvider;

		/// <summary>
		/// Gets or sets the default <see cref="IContainerBehaviour"/> used by classes derived from 
		...
		/// <see cref="IContainerBehaviour.Configure(IContainer, ITargetContainer)"/> method is called - therefore
		...
		public static IContainerBehaviour DefaultProvider
		{
			get
			{
