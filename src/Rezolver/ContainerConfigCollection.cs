...
namespace Rezolver
{
    ...
    public class ContainerConfigCollection : DependantCollection<IContainerConfig>, IContainerConfig
    {
        /// <summary>
        /// Constructs a new instance of the <see cref="ContainerConfigCollection"/> type
        /// </summary>
        public ContainerConfigCollection()
        {

        }

        /// <summary>
        /// Constructs a new instance of the <see cref="ContainerConfigCollection"/> class by cloning an existing one.
        /// </summary>
        /// <param name="collection">The collection whose elements are to be copied.  If null, then the collection is initialised
        /// empty.</param>
        public ContainerConfigCollection(ContainerConfigCollection collection)
        ...
        /// <summary>
        /// Constructs a new instance of the <see cref="ContainerConfigCollection"/> type, using the passed behaviours
        ...
        public ContainerConfigCollection(IEnumerable<IContainerConfig> behaviours)
            : base(behaviours)
        {
        ...
        /// </summary>
        /// <param name="behaviours">The behaviours to be added to the collection on construction.</param>
        public ContainerConfigCollection(params IContainerConfig[] behaviours)
        ...
        /// order, calling its <see cref="IContainerConfig.Attach(IContainer, ITargetContainer)"/> method.</remarks>
