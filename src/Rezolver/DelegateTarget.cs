...
namespace Rezolver
{
	...
	public class DelegateTarget<T> : TargetBase
	{
		...
		private readonly Func<RezolveContext, T> _factory2;
		...
		public DelegateTarget(Func<RezolveContext, T> factory, Type declaredType = null)
		{
			factory.MustNotBeNull("factory");
			_factory2 = factory;
			if (declaredType != null)
		...
		protected override Expression CreateExpressionBase(CompileContext context)
		{
			...
			return Expression.Invoke(Expression.Constant(_factory2), ExpressionHelper.RezolveContextParameterExpression);
		}
