...
namespace Rezolver
{
	...
	/// implementation of the <see cref="ITarget.CreateExpression(CompileContext)"/> method.
	/// </summary>
	public static class ExpressionHelper
	{
		...
		/// <summary>
		/// Makes an expression which represents calling the <see cref="LifetimeScopeRezolverExtensions.GetOrAdd{T}(IScopedContainer, RezolveContext, Func{RezolveContext, T}, bool)"/>
