...
namespace Rezolver
{
    ...
    public static class GlobalBehaviours
    {
        ...
        {
            // no special behaviours for the options TargetContainer
            //_globalOptions = new TargetContainer(new TargetContainerBehaviourCollection());
            //_globalOptions.SetOption(typeof(TargetContainer), 
            //    new TargetContainerBehaviourCollection(
            //        AutoEnumerableBehaviour.Instance,
