...
namespace Rezolver
{
    ...
    /// 
    /// The automatic injection of enumerables, for example, is enabled by applying the <see cref="Behaviours.AutoEnumerableBehaviour"/>
    ...
    /// <seealso cref="Behaviours.ContextResolvingBehaviour"/>
