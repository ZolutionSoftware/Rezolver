...
{
	//factory methods to aid in creating ExpressionTarget instances from expressions without having to resort
	//to ludicrous amounts of angle brackets.	

	public partial class ExpressionTarget
	{ 
		
		/// <summary>Creates a target from the passed lambda expression.  The numerous overloads exist to simplify the translation of expressions into targets.</summary>
		/// <typeparam name="TResult">The type of object produced by the lambda expression.</typeparam>
		/// <param name="expression">The lambda expression that is to be converted into an ExpressionTarget</param>
		/// <remarks>Whilst creating ExpressionTargets is simple enough; the nature of the C# and VB compilers is that
		/// you need a function to declare an expression parameter of the specific delegate type you need in order to be
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<TResult>(Expression<Func<TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<TResult>(Expression<Func<ResolveContext, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T, TResult>(Expression<Func<T, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T, TResult>(Expression<Func<ResolveContext, T, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, TResult>(Expression<Func<T1, T2, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, TResult>(Expression<Func<ResolveContext, T2, T3, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, TResult>(Expression<Func<T1, T2, T3, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, TResult>(Expression<Func<ResolveContext, T2, T3, T4, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, TResult>(Expression<Func<T1, T2, T3, T4, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, TResult>(Expression<Func<T1, T2, T3, T4, T5, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, T7, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, T7, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, T7, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, T7, T8, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, T7, T8, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, T7, T8, T9, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, T7, T8, T9, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
		...
		/// able to pass a whole lambda expression as if it were code.  Hence the need for these static factory methods.
		/// </remarks>
		public static ExpressionTarget From<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TResult>> expression)
		{
			return new ExpressionTarget(expression);
		}
	}
