...
// Generated by DelegateTarget.CreateAndRegister.tt using ..\genericgenerator.t4 at Thu 09 Mar, 2017 00:38:58
...
namespace Rezolver
{
	...
	public static partial class Target
	{
		...
		/// if different from <typeparamref name="TResult" /></param>
		/// <remarks>All arguments to the delegate are injected from the container when executed</remarks>
		public static ITarget ForDelegate<T2, TResult>(Func<ResolveContext, T2, TResult> factory, Type declaredType = null)
		{
			if(factory == null) throw new ArgumentNullException(nameof(factory));
			return new DelegateTarget(factory, declaredType);
		}
		...
		/// if different from <typeparamref name="TResult" /></param>
		/// <remarks>All arguments to the delegate are injected from the container when executed</remarks>
		public static ITarget ForDelegate<T2, T3, TResult>(Func<ResolveContext, T2, T3, TResult> factory, Type declaredType = null)
		{
			if(factory == null) throw new ArgumentNullException(nameof(factory));
			return new DelegateTarget(factory, declaredType);
		}
		...
		/// if different from <typeparamref name="TResult" /></param>
		/// <remarks>All arguments to the delegate are injected from the container when executed</remarks>
		public static ITarget ForDelegate<T2, T3, T4, TResult>(Func<ResolveContext, T2, T3, T4, TResult> factory, Type declaredType = null)
		{
			if(factory == null) throw new ArgumentNullException(nameof(factory));
			return new DelegateTarget(factory, declaredType);
		}
		...
		/// if different from <typeparamref name="TResult" /></param>
		/// <remarks>All arguments to the delegate are injected from the container when executed</remarks>
		public static ITarget ForDelegate<T2, T3, T4, T5, TResult>(Func<ResolveContext, T2, T3, T4, T5, TResult> factory, Type declaredType = null)
		{
			if(factory == null) throw new ArgumentNullException(nameof(factory));
			return new DelegateTarget(factory, declaredType);
		}
...
namespace Rezolver
{
	...
	public static partial class DelegateTargetContainerExtensions
	{
		...
		/// <param name="declaredType">Optional.  The <see cref="ITarget.DeclaredType" /> of the target to be created
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		public static void RegisterDelegate<T2, TResult>(this ITargetContainer targets, Func<ResolveContext, T2, TResult> factory, Type declaredType = null)
		{
			targets.RegisterDelegate((Delegate)factory, declaredType);
		}
		...
		/// <param name="declaredType">Optional.  The <see cref="ITarget.DeclaredType" /> of the target to be created
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		public static void RegisterDelegate<T2, T3, TResult>(this ITargetContainer targets, Func<ResolveContext, T2, T3, TResult> factory, Type declaredType = null)
		{
			targets.RegisterDelegate((Delegate)factory, declaredType);
		}
		...
		/// <param name="declaredType">Optional.  The <see cref="ITarget.DeclaredType" /> of the target to be created
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		public static void RegisterDelegate<T2, T3, T4, TResult>(this ITargetContainer targets, Func<ResolveContext, T2, T3, T4, TResult> factory, Type declaredType = null)
		{
			targets.RegisterDelegate((Delegate)factory, declaredType);
		}
		...
		/// <param name="declaredType">Optional.  The <see cref="ITarget.DeclaredType" /> of the target to be created
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		public static void RegisterDelegate<T2, T3, T4, T5, TResult>(this ITargetContainer targets, Func<ResolveContext, T2, T3, T4, T5, TResult> factory, Type declaredType = null)
		{
			targets.RegisterDelegate((Delegate)factory, declaredType);
		}
