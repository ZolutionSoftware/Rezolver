...
// Generated by ExpressionTarget.CreateAndRegister.tt using ..\genericgenerator.t4 at Thu 09 Mar, 2017 00:46:27
...
namespace Rezolver
{
	...
	public static partial class Target
	{
		...
		/// <summary>Creates an <see cref="Rezolver.Targets.ExpressionTarget" /> for a lambda expression which takes a
		/// <see cref="ResolveContext" /> plus 1 other argument, and which returns
		/// an instance of <typeparamref name="TResult" /></summary>
		...
		/// if different from <typeparamref name="TResult" /></param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static ITarget ForExpression<T2, TResult>(Expression<Func<ResolveContext, T2, TResult>> lambda, Type declaredType = null)
		{
			if(lambda == null) throw new ArgumentNullException(nameof(lambda));
			return new ExpressionTarget(lambda, declaredType);
		}
		...
		/// <summary>Creates an <see cref="Rezolver.Targets.ExpressionTarget" /> for a lambda expression which takes a
		/// <see cref="ResolveContext" /> plus 2 other arguments, and which returns
		/// an instance of <typeparamref name="TResult" /></summary>
		/// <typeparam name="T2">Type of the 2nd parameter of the lambda expression.</typeparam>
		...
		/// if different from <typeparamref name="TResult" /></param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static ITarget ForExpression<T2, T3, TResult>(Expression<Func<ResolveContext, T2, T3, TResult>> lambda, Type declaredType = null)
		{
			if(lambda == null) throw new ArgumentNullException(nameof(lambda));
			return new ExpressionTarget(lambda, declaredType);
		}
		...
		/// <summary>Creates an <see cref="Rezolver.Targets.ExpressionTarget" /> for a lambda expression which takes a
		/// <see cref="ResolveContext" /> plus 3 other arguments, and which returns
		/// an instance of <typeparamref name="TResult" /></summary>
		/// <typeparam name="T2">Type of the 2nd parameter of the lambda expression.</typeparam>
		/// <typeparam name="T3">Type of the 3rd parameter of the lambda expression.</typeparam>
		...
		/// if different from <typeparamref name="TResult" /></param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static ITarget ForExpression<T2, T3, T4, TResult>(Expression<Func<ResolveContext, T2, T3, T4, TResult>> lambda, Type declaredType = null)
		{
			if(lambda == null) throw new ArgumentNullException(nameof(lambda));
			return new ExpressionTarget(lambda, declaredType);
		}
		...
		/// <summary>Creates an <see cref="Rezolver.Targets.ExpressionTarget" /> for a lambda expression which takes a
		/// <see cref="ResolveContext" /> plus 4 other arguments, and which returns
		/// an instance of <typeparamref name="TResult" /></summary>
		/// <typeparam name="T2">Type of the 2nd parameter of the lambda expression.</typeparam>
		/// <typeparam name="T3">Type of the 3rd parameter of the lambda expression.</typeparam>
		/// <typeparam name="T4">Type of the 4th parameter of the lambda expression.</typeparam>
		...
		/// if different from <typeparamref name="TResult" /></param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static ITarget ForExpression<T2, T3, T4, T5, TResult>(Expression<Func<ResolveContext, T2, T3, T4, T5, TResult>> lambda, Type declaredType = null)
		{
			if(lambda == null) throw new ArgumentNullException(nameof(lambda));
			return new ExpressionTarget(lambda, declaredType);
		}
...
namespace Rezolver
{
	...
	public static partial class ExpressionTargetContainerExtensions
	{
		...
		public static void RegisterExpression<TResult>(this ITargetContainer targets, Expression<Func<TResult>> lambda, Type declaredType = null)
		{
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<TResult>(this ITargetContainer targets, Expression<Func<ResolveContext, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<T1, TResult>(this ITargetContainer targets, Expression<Func<T1, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}

		/// <summary>Registers an <see cref="Rezolver.Targets.ExpressionTarget" /> built from a lambda expression which takes a 
		/// <see cref="ResolveContext" /> plus 1 other argument, and which returns an instance of <typeparamref name="TResult" /></summary>
		/// <typeparam name="T2">Type of the 2nd parameter of the lambda expression.</typeparam>
		/// <typeparam name="TResult">The return type of the lambda expression.</typeparam>
		/// <param name="targets">Required.  The <see cref="ITargetContainer" /> into which the newly created target will be registered</param>
		/// <param name="lambda">Required.  The lambda expression which is to be compiled and executed when an instance is resolved by a container</param>
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<T2, TResult>(this ITargetContainer targets, Expression<Func<ResolveContext, T2, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<T1, T2, TResult>(this ITargetContainer targets, Expression<Func<T1, T2, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}

		/// <summary>Registers an <see cref="Rezolver.Targets.ExpressionTarget" /> built from a lambda expression which takes a 
		/// <see cref="ResolveContext" /> plus 2 other arguments, and which returns an instance of <typeparamref name="TResult" /></summary>
		/// <typeparam name="T2">Type of the 2nd parameter of the lambda expression.</typeparam>
		/// <typeparam name="T3">Type of the 3rd parameter of the lambda expression.</typeparam>
		/// <typeparam name="TResult">The return type of the lambda expression.</typeparam>
		/// <param name="targets">Required.  The <see cref="ITargetContainer" /> into which the newly created target will be registered</param>
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<T2, T3, TResult>(this ITargetContainer targets, Expression<Func<ResolveContext, T2, T3, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<T1, T2, T3, TResult>(this ITargetContainer targets, Expression<Func<T1, T2, T3, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}

		/// <summary>Registers an <see cref="Rezolver.Targets.ExpressionTarget" /> built from a lambda expression which takes a 
		/// <see cref="ResolveContext" /> plus 3 other arguments, and which returns an instance of <typeparamref name="TResult" /></summary>
		/// <typeparam name="T2">Type of the 2nd parameter of the lambda expression.</typeparam>
		/// <typeparam name="T3">Type of the 3rd parameter of the lambda expression.</typeparam>
		/// <typeparam name="T4">Type of the 4th parameter of the lambda expression.</typeparam>
		/// <typeparam name="TResult">The return type of the lambda expression.</typeparam>
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<T2, T3, T4, TResult>(this ITargetContainer targets, Expression<Func<ResolveContext, T2, T3, T4, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<T1, T2, T3, T4, TResult>(this ITargetContainer targets, Expression<Func<T1, T2, T3, T4, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}

		/// <summary>Registers an <see cref="Rezolver.Targets.ExpressionTarget" /> built from a lambda expression which takes a 
		/// <see cref="ResolveContext" /> plus 4 other arguments, and which returns an instance of <typeparamref name="TResult" /></summary>
		/// <typeparam name="T2">Type of the 2nd parameter of the lambda expression.</typeparam>
		/// <typeparam name="T3">Type of the 3rd parameter of the lambda expression.</typeparam>
		/// <typeparam name="T4">Type of the 4th parameter of the lambda expression.</typeparam>
		/// <typeparam name="T5">Type of the 5th parameter of the lambda expression.</typeparam>
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<T2, T3, T4, T5, TResult>(this ITargetContainer targets, Expression<Func<ResolveContext, T2, T3, T4, T5, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}
		...
		/// if different from <typeparamref name="TResult" />.  Also overrides the type against which the registration will be made.</param>
		/// <remarks>All arguments to the lambda are injected from the container when compiled and executed</remarks>
		public static void RegisterExpression<T1, T2, T3, T4, T5, TResult>(this ITargetContainer targets, Expression<Func<T1, T2, T3, T4, T5, TResult>> lambda, Type declaredType = null)
		{
			targets.RegisterExpression((Expression)lambda, declaredType);
		}
	}
