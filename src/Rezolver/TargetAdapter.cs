...
namespace Rezolver
{
    ...
    public class TargetAdapter : ExpressionVisitor, ITargetAdapter
    {
        internal class RezolveCallExpressionInfo
        {
            ...
            public ITarget Name { get; private set; }

            internal RezolveCallExpressionInfo(Type type, ITarget name)
            {
                Type = type;
                Name = name;
            }
        ...
        internal RezolveCallExpressionInfo ExtractRezolveCall(Expression e)
        {
            ...
            return nameParameter != null
                ? new RezolveCallExpressionInfo(methodExpr.Method.GetGenericArguments()[0], CreateTarget(methodExpr.Arguments[0]))
