...
namespace Rezolver
{
  ...
  public abstract class TargetBase : ITarget
  {
    ...
    /// <summary>
    /// If false (the default) then any expression produced by <see cref="CreateExpressionBase(ICompileContext)"/> will be automatically 
    ...
    /// 
    /// Note - you can still call the <see cref="CreateScopeTrackingExpression(ICompileContext, Expression)"/> method if the expression
