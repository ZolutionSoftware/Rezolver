...
{
    /// <summary>
    /// Has been replaced by the <see cref="Target"/> static class, and will be removed in 1.2
    /// </summary>
    [Obsolete("This static class has been replaced by the Target static class and will be obsoleted in 1.2, please remove all references to it")]
	public static class TargetCreationExtensions
    {
        /// <summary>
        /// This method will be removed in 1.2 in favour of Target.ForObject&lt;T&gt;(T)"
        /// 
        ...
        /// <summary>
        /// This method will be removed in 1.2 in favour of the Target.ForDelegate static methods
        /// 
        ...
        [Obsolete("This method will be removed in 1.2 in favour of the Target.ForDelegate static methods")]
