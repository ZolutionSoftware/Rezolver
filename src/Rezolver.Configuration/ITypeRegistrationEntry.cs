...
namespace Rezolver.Configuration
{
  ...
  public interface ITypeRegistrationEntry : IConfigurationEntry
  {
    ...
    /// <see cref="SingletonTargetDictionaryExtensions.RegisterMultiple(ITargetContainer, System.Collections.Generic.IEnumerable{ITarget}, Type, RezolverPath)"/> method call.
    /// </summary>
