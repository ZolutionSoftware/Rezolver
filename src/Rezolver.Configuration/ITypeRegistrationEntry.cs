...
{
	/// <summary>
	/// Represents an instruction to register one or more targets in an <see cref="IRezolverBuilder"/> against one or more 
	...
	{
		/// <summary>
		/// The types for which the registration is to be made in the <see cref="IRezolverBuilder"/> that the entry is applied to.
		/// </summary>
		...
		/// <see cref="IRezolverBuilderExtensions.RegisterMultiple(IRezolverBuilder, System.Collections.Generic.IEnumerable{IRezolveTarget}, Type, RezolverPath)"/> method call.
		/// </summary>
