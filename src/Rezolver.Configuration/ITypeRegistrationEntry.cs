...
namespace Rezolver.Configuration
{
  ...
  public interface ITypeRegistrationEntry : IConfigurationEntry
  {
    ...
    /// <see cref="SingletonTargetContainerExtensions.RegisterMultiple(ITargetContainer, System.Collections.Generic.IEnumerable{ITarget}, Type, RezolverPath)"/> method call.
    /// </summary>
